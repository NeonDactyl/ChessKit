...
using static NeonDactyl.ChessLogic.Primitives.MoveAnnotations;
...
namespace NeonDactyl.ChessLogic.Algorithms
{
    public static class San
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static string GetSanIndex(this Position position)
        {
        ...
        /// <returns></returns>
        public static string GetSanEnd(this Position position, Move move)
        {
            if (position == null) throw new ArgumentNullException(nameof(position));
        ...
        /// <param name="move">The move</param>
        /// <returns></returns>
        public static string GetSanBegin(this Position position, LegalMove move)
        {
            if (position == null) throw new ArgumentNullException(nameof(position));
        ...
        public static string GetSan(this Position position, LegalMove move)
        {
            if (position == null) throw new ArgumentNullException(nameof(position));
        ...
        /// <returns></returns>
        public static LegalMove ParseMoveFromSan(this Position position, string san)
        {
            if (position == null) throw new ArgumentNullException(nameof(position));
